...
// node_modules/million/dist/shared/million.5ae52264.mjs
...
// node_modules/million/dist/shared/million.7c9cff69.mjs
...
var renderReactScope = (vnode, unstable, portals, currentIndex, server) => {
  ...
  if ((0, import_react.isValidElement)(vnode) && typeof vnode.type === "function" && "callable" in vnode.type) {
...
var block2 = (fn, { block: compiledBlock, shouldUpdate, svg, as } = {}) => {
  ...
  const MillionBlock = (props, forwardedRef) => {
    ...
    const vnode = (0, import_react2.createElement)(
      ...
      null,
      marker,
      (0, import_react2.createElement)(Effect, { effect }),
